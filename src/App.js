...
export default function App() {
  ...
  /* Ao iniciar carrega dados do servidor */
  useEffect(() => {
  ...
  //evento de press para incrementar like
  async function handleLikeRepository(id) {
    ...
    if (repoIndex >= 0) {
      ...
      //retirar o item do array para poder adicionar novamente com os likes incrementados
      // Utilizado ṕara respeitar a imutabilidade
